...
namespace programme_poo
{
    ...
    class Etudiant : Personne
    {
        ...
        protected virtual void AfficherProfPrincipal()
        {
            if (professeurPrincipal != null)
            {
                Console.WriteLine("  Son professeur principal est ");
    ...
    class Personne
    {
        ...
        protected virtual void AfficherNomEtAge()
        {
